...
def init_colors(n):
    for i in range(n):
        list_of_colors.append(random.randint(0,255))
...
def dfs(mystatedict,statedict,numcolors,current_state,states,num):
    ...
    for i in range(len(current_state.next)):
        ...
        temp_list_of_colors = list_of_colors.copy()
    
        current_state.next[i].next = generate_colors(states,num+1,numcolors,temp_list_of_colors)
...
if __name__ == "__main__":
    ...
    list_of_colors = ["red","blue","green","black"]
