...
def heuristic_included(mystatedict,statedict,numcolors,current_state,states,num,legal_colors):
    global backtracks
    #pdb.set_trace()
    ...
    for i in range(len(current_state.next)):
        ...
        backtracks +=1
        update_neighbors(current_state.next[0].myname,temp_legal_colors,statedict,current_state.next[i].mycolor,states)
        ...
        #mystatedict[current_state.next[i].next[0].myname] =   
        ...
        ans = heuristic_included(mystatedict,statedict,numcolors,current_state.next[i],states,num+1,temp_legal_colors)
        if ans[0] == 1:
            return 1,mystatedict
